			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
							<label class="label"><s:text name="text.bevande" /></label>				
					</div>
					<div class="col-md-12 text-center">
							<img class="resize" src="/progetto/img/bevande.png" />
					</div>
				</div>
				<div class="row">	
					<div class="col-md-2 text-center"></div>				
					<div class="col-md-4 text-center">
						<a href="/progetto/bevanda/NuovaBevanda">
							<div class="service">
					...
					<div class="col-md-4 text-center">
						<a href="/progetto/bevanda/ChiediCercaBevanda">
							<div class="service">
