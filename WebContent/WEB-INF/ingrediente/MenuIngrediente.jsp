			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
							<label class="label"><s:text name="text.ingredienti" /></label>				
					</div>
					<div class="col-md-12 text-center">
							<img class="resize" src="/progetto/img/ingredienti.png" />
					</div>
				</div>
				<div class="row">	
					<div class="col-md-2 text-center"></div>				
					<div class="col-md-4 text-center">
						<a href="/progetto/ingrediente/NuovoIngrediente">
							<div class="service">
					...
					<div class="col-md-4 text-center">
						<a href="/progetto/ingrediente/ChiediCercaIngrediente">
							<div class="service">
