...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
							<label class="label"><s:text name="text.piatti" /></label>				
					</div>
					<div class="col-md-12 text-center">
							<img class="resize" src="/progetto/img/piatti.png" />
					</div>
				</div>
				<div class="row">	
					<div class="col-md-2 text-center"></div>				
					<div class="col-md-4 text-center">
						<a href="/progetto/piatto/NuovoPiatto">
							<div class="service">
					...
					<div class="col-md-4 text-center">
						<a href="/progetto/piatto/ChiediCercaPiatto">
							<div class="service">
	...
	</div><%@ include file="/includeFile/footer.txt"%>
