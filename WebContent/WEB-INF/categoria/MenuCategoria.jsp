			...
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-center">
							<label class="label"><s:text name="text.categorie" /></label>				
					</div>
					<div class="col-md-12 text-center">
							<img class="resize" src="/progetto/img/categorie.png" />
					</div>
				</div>
				<div class="row">	
					<div class="col-md-2 text-center"></div>				
					<div class="col-md-4 text-center">
						<a href="/progetto/categoria/NuovaCategoria">
							<div class="service">
								<i class="fas fa-plus fa-2x" area-hidden="true"></i>
								<h4>
									<s:text name="text.nuova" />
								</h4>
							</div>
						</a>
					</div>
					<div class="col-md-4 text-center">
						<a href="/progetto/categoria/ChiediCercaCategoria">
							<div class="service">
